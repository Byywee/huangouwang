...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    else
    {
		...
		//获取退货时长
		$sql_date = "SELECT sale_return_able_date FROM " . $ecs->table('goods') . " WHERE goods_id = '$_REQUEST[goods_id]'";
		$date = $db->getOne($sql_date);
		switch($date)
		{
			case       60*60*24*7 : $goods['sale_return_able_date'] = 'oneweek'; break;
			case      60*60*24*30 : $goods['sale_return_able_date'] = 'onemonth'; break;
			case    60*60*24*30*3 : $goods['sale_return_able_date'] = 'threemonths'; break;
			case    60*60*24*30*6 : $goods['sale_return_able_date'] = 'sixmonths'; break;
			case   60*60*24*30*12 : $goods['sale_return_able_date'] = 'oneyear'; break;
			default               : $goods['sale_return_able_date'] = '';
		}
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $is_shipments = isset($_POST['is_shipments']) ? intval($_POST['is_shipments']) : 0;
	$sale_return_able = isset($_POST['sale_return_able']) ? intval($_POST['sale_return_able']) : 1;
	$sale_return_able_date_temp = isset($_POST['sale_return_able_date']) ? $_POST['sale_return_able_date'] : '';
	switch($sale_return_able_date_temp)
	{
		case       'oneweek' : $sale_return_able_date = 60*60*24*7; break;
		case      'onemonth' : $sale_return_able_date = 60*60*24*30; break;
		case   'threemonths' : $sale_return_able_date = 60*60*24*30*3; break;
		case     'sixmonths' : $sale_return_able_date = 60*60*24*30*6; break;
		case       'oneyear' : $sale_return_able_date = 60*60*24*30*12; break;
		default              : $sale_return_able_date = 0;
	} 
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "suppliers_id, is_shipments,sale_return_able,sale_return_able_date)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$rank_integral', '$suppliers_id', '$is_shipments', ".
                    " '$sale_return_able','$sale_return_able_date')";
        }
        else
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    ...
                    "is_shipments,sale_return_able,sale_return_able_date)" .
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$is_promote','$promote_price', ".
                    "'$promote_start_date', '$promote_end_date', '$goods_img', '$goods_thumb', '$original_img', ".
                    "'$_POST[keywords]', '$_POST[goods_brief]', '$_POST[seller_note]', '$goods_weight', '$goods_number',".
                    " '$warn_number', '$_POST[integral]', '$give_integral', '$is_best', '$is_new', '$is_hot', 0, '$is_on_sale', '$is_alone_sale', $is_shipping, ".
                    " '$_POST[goods_desc]', '" . gmtime() . "', '". gmtime() ."', '$goods_type', '$code', '$rank_integral', '$is_shipments', ".
                    " '$sale_return_able','$sale_return_able_date')";
        }
    }
    else
    {
        ...
        $sql = "UPDATE " . $ecs->table('goods') . " SET " .
                ...
                "is_shipments = $is_shipments,".
				"sale_return_able = $sale_return_able,".
				"sale_return_able_date = $sale_return_able_date";
