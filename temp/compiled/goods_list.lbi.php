...
?>
    <?php if ($this->_var['goods']['goods_id']): ?>
     <div class="goodsItem">
           <a href="<?php echo $this->_var['goods']['url']; ?>" class="goodsimglink"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" alt="<?php echo $this->_var['goods']['goods_name']; ?>" class="goodsimg" /></a><br />
           <div class="goods_jj">
               ...
               <?php if ($this->_var['show_marketprice']): ?>
                ...
                <?php endif; ?>
               <div class="goods_button"><a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>);" class="f6 collect"><?php echo $this->_var['lang']['btn_collect']; ?></a>
               <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>)" class="f6 shoping_cat">加入购物车</a></div>
           </div>
        </div>
    <?php endif; ?>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
