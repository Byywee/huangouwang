   ...
   <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
          <tr>
            ...
            <td width="85%"><input name="username" type="text" size="25" class="com-ipt-1" /></td>
          </tr>
          <tr>
            <td align="right"><?php echo $this->_var['lang']['label_password']; ?></td>
            <td>
            <input name="password" type="password" size="15"  class="com-ipt-1"/>
            </td>
          </tr>
          <?php if ($this->_var['enabled_captcha']): ?>
          <tr>
            <td align="right"><?php echo $this->_var['lang']['comment_captcha']; ?></td>
            <td><input type="text" size="8" name="captcha" class="com-ipt-1" />
    ...
    <form action="user.php" method="post" name="formUser" onsubmit="return register();">
      <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
        <tr>
          ...
          <td width="87%">
          <input name="username" type="text" size="25" id="username" onblur="is_registered(this.value);" class="com-ipt-1"/>
        ...
        <tr>
          ...
          <td>
          <input name="email" type="text" size="25" id="email" onblur="checkEmail(this.value);"  class="com-ipt-1"/>
        ...
        <tr>
          <td align="right"><?php echo $this->_var['lang']['label_password']; ?></td>
          <td>
          <input name="password" type="password" id="password1" onblur="check_password(this.value);" onkeyup="checkIntensity(this.value)" class="com-ipt-1" style="width:179px;" />
        ...
        <tr>
          ...
          <td>
          <input name="confirm_password" type="password" id="conform_password" onblur="check_conform_password(this.value);"  class="com-ipt-1" style="width:179px;"/>
	...
	<?php if ($this->_var['field']['id'] == 6): ?>
	  ...
	  <?php echo $this->html_options(array('options'=>$this->_var['passwd_questions'])); ?>
        ...
        <tr>
          ...
          <td>
	  <input name="passwd_answer" type="text" size="25" class="com-ipt-1" maxlengt='20'/><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>
          </td>
        </tr>
	<?php else: ?>
        <tr>
          ...
          <td>
          <input name="extend_field<?php echo $this->_var['field']['id']; ?>" type="text" size="25" class="com-ipt-1" /><?php if ($this->_var['field']['is_need']): ?><span style="color:#FF0000"> *</span><?php endif; ?>
          </td>
        </tr>
	<?php endif; ?>
    ...
    <form action="user.php" method="post" name="getPassword" onsubmit="return submitPwdInfo();">
        ...
        <table width="70%" border="0" align="center">
          ...
          <tr>
            ...
            <td width="61%"><input name="user_name" type="text" size="30" class="com-ipt-1" /></td>
          </tr>
          <tr>
            <td align="right"><?php echo $this->_var['lang']['email']; ?></td>
            <td><input name="email" type="text" size="30" class="com-ipt-1" /></td>
          </tr>
          <tr>
            <td></td>
            <td><input type="hidden" name="act" value="send_pwd_email" />
              <input type="submit" name="submit" value="<?php echo $this->_var['lang']['submit']; ?>" class="com-btn-1"  />
              <input name="button" type="button" onclick="history.back()" value="<?php echo $this->_var['lang']['back_page_up']; ?>"  class="com-btn-1" />
	    </td>
          </tr>
        </table>
        <br />
    ...
    <form action="user.php" method="post">
        ...
        <table width="70%" border="0" align="center">
          ...
          <tr>
            ...
            <td><input name="passwd_answer" type="text" size="20" class="com-ipt-1" /></td>
          </tr>
          <?php if ($this->_var['enabled_captcha']): ?>
          <tr>
            <td align="right"><?php echo $this->_var['lang']['comment_captcha']; ?></td>
    ...
    <form action="user.php" method="post" name="getPassword2" onSubmit="return submitPwd()">
      ...
      <table width="80%" border="0" align="center">
        <tr>
          ...
          <td><input name="new_password" type="password" size="25" class="com-ipt-1" /></td>
        </tr>
        <tr>
          <td><?php echo $this->_var['lang']['confirm_password']; ?>:</td>
          <td><input name="confirm_password" type="password" size="25"  class="com-ipt-1"/></td>
        </tr>
        <tr>
