		...
		<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                <tr>
                  <td colspan="2" align="center" bgcolor="#FFFFFF"><input name="act" type="hidden" value="act_edit_profile" />
                    <input name="submit" type="submit" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" class="com-btn-1" />
                  </td>
                </tr>
       </table>
    </form>
     ...
     <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        ...
        <tr>
          <td colspan="2" align="center" bgcolor="#FFFFFF"><input name="act" type="hidden" value="act_edit_password" />
            <input name="submit" type="submit" class="com-btn-1" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" />
          </td>
        </tr>
      </table>
    </form>
...
?>
      ...
      <form name="addBouns" action="user.php" method="post" onSubmit="return addBonus()">
        ...
        <?php echo $this->_var['lang']['bonus_number']; ?>
          ...
          <input type="submit" class="com-btn-1" value="<?php echo $this->_var['lang']['add_bonus']; ?>" />
        </div>
      </form>
    <?php endif; ?>
        ...
        <form action="user.php" method="post" name="formOrder" onsubmit="return mergeOrder()">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              ...
              <input type="submit" name="Submit"  class="com-btn-1"  value="<?php echo $this->_var['lang']['merge_order']; ?>" /></td>
            </tr>
            <tr>
           ...
           <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              ...
              <tr>
                <td colspan="4" align="center" bgcolor="#ffffff"><input type="hidden" name="act" value="save_order_address" />
                  ...
                  <input type="submit" class="com-btn-1" value="<?php echo $this->_var['lang']['update_address']; ?>"  />
                </td>
              </tr>
            </table>
          </form>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          ...
          <tr>
            ...
            <input type="hidden" name="surplus_type" value="1" />
              ...
              <input type="submit" name="submit"  class="com-btn-1" value="<?php echo $this->_var['lang']['submit_request']; ?>" />
              <input type="reset" name="reset" class="com-btn-1" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
            </td>
          </tr>
        </table>
        </form>
...
?>
        ...
        <input type="hidden" name="surplus_type" value="0" />
          ...
          <input type="hidden" name="act" value="act_account" />
          <input type="submit" class="com-btn-1" name="submit" value="<?php echo $this->_var['lang']['submit_request']; ?>" />
          <input type="reset" class="com-btn-1" name="reset" value="<?php echo $this->_var['lang']['button_reset']; ?>" />
        </td>
      </tr>
          </table>
        </form>
...
?>
                ...
                <tr>
                  ...
                  <td colspan="3" align="center" bgcolor="#ffffff"><?php if ($this->_var['consignee']['consignee'] && $this->_var['consignee']['email']): ?>
                    <input type="submit" name="submit" class="com-btn-1" value="<?php echo $this->_var['lang']['confirm_edit']; ?>" />
                    ...
                    <?php else: ?>
                    <input type="submit" name="submit" class="com-btn-1"  value="<?php echo $this->_var['lang']['add_address']; ?>"/>
                    <?php endif; ?>
