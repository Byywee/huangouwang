                  ...
                  <table width="100%" border="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td><input type="hidden" name="act" value="act_add_message" />
                        <input type="submit" value="<?php echo $this->_var['lang']['submit']; ?>" class="com-btn-1" />
                      </td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
...
?>
    ...
    <tr>
      <td colspan="2" align="center" bgcolor="#ffffff"><input type="button" name="gen_code" value="<?php echo $this->_var['lang']['generate']; ?>" onclick="genCode()" class="com-btn-1" />
			</td>
  </tr>
    <tr>
